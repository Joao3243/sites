<?php
    if(isset($_POST['submit']))
    {
        ...
        $estado=$_POST['estado'];
        $ender=$_POST['ender'];
        $result=mysqli_query($conexao,"INSERT INTO usuarios(nome,email,telefone,sexo,data_nasc,cidade,estado,endereco) VALUES ('$nome',
        '$email','$telefone','$sexo','$data_nasc','$cidade','$estado','$ender')");
    };  
?>
<!DOCTYPE html>
<html lang="pt-BR">
    ...
    <div class="box">
        <form action="index.php" method="POST">
            <fieldset>
                ...
                <br><br>
                <div class="inputbox">
                    <input type="text" name="ender" id="ender" class="inputUser" required>
